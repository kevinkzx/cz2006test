...
const panes = [
	...
	},
	{
		...
		render: () => <Tab.Pane attached={false}>
			<Container>
				Ashes of the deceased may be scattered at sea. The Maritime Port Authority (MPA) has designated a site
				located
...
const cremation_burialPage = () => <Tab menu={{color: 'green', secondary: true, pointing: true, attached: false}}
                                        panes={panes}/>
