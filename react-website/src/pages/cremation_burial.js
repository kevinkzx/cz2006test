...
const panes = [
  ...
  },
  {
    ...
    render: () => <Tab.Pane attached={false}>
        <Container>
        Ashes of the deceased may be scattered at sea. The Maritime Port Authority (MPA) has designated a site located 
...

  {
    ...
    render: () => <Tab.Pane attached={false}>
        ...
        Currently, the Choa Chu Kang Cemetery Complex is the only cemetery in Singapore still open for burials. 
        <br></br>
        <br></br>
        ...
        Documents required for verification before booking: <br></br>
            ...
            &emsp;• Identification Papers of Next-of-Kin and Applicant (NRIC, Passport, etc), or Letter of Authorisation if applicant is not Next-of-Kin <br></br><br></br>
...
const cremation_burialPage = () => <Tab  menu={{ color:'green', secondary:true, pointing:true, attached:false}} panes={panes} />
